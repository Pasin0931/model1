...
CLASSES = ["BACKGROUND", "AEROPLANE", "BICYCLE", "BIRD", "BOAT", "BOTTLE", "BUS", "CAR", "CAT", "CHAIR", "COW","DINNINGTABLE" ,"DOG", "HORSE", "MOTORBIKE", "PERSON", "POTTEDPLANT", "SHEEP", "SOFA", "TRAIN", "TVMONITOR"]

COLORS = np.random.uniform(0, 100, size=(len(CLASSES), 3))

net = cv2.dnn.readNetFromCaffe("mobileNet/MobileNetSSD.prototxt", "mobileNet/MobileNetSSD.caffemodel") #caffemodel ---> (model) #prototxt ---> layer for value
